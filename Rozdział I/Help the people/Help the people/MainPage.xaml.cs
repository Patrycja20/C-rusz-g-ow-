...
namespace Help_the_people
{
    /// <summary>
    /// A basic page that provides characteristics common to most applications.
    /// </summary>
    public sealed partial class MainPage : Help_the_people.Common.LayoutAwarePage
    {
        ...
        public MainPage()
        {
            ...
            targetTimer.Interval += TimeSpan.FromSeconds(0.3);
            }
        ...
        private void playArea_PointerMoved(object sender, PointerRoutedEventArgs e)
        {
            if (humanCaptured)
            {
                ...
                if ((Math.Abs(relativePosition.X - Canvas.GetLeft(human))>human.ActualWidth * 5) || (Math.Abs(relativePosition.Y - Canvas.GetTop(human))> human.ActualHeight * 5))
                {
                    humanCaptured = false;
                    human.IsHitTestVisible = true;
                }
